...
model = Climate_encoder_free_uncertain_region(
    len(paths_to_data),
    2,
...
fit_velocity(
    ...
    H,
    W,
    types="train_10year_2day_mm_" + str(args.region),
...
fit_velocity(
    ...
    H,
    W,
    types="val_10year_2day_mm_" + str(args.region),
    vel_model=Optim_velocity,
    kernel=kernel,
    lat=lat,
    lon=lon,
...
fit_velocity(
    ...
    H,
    W,
    types="test_10year_2day_mm_" + str(args.region),
    vel_model=Optim_velocity,
    kernel=kernel,
    lat=lat,
    lon=lon,
